...
sample_name = "stamp_06_21_camera_20"
gpu_number = "4"
use_neptune = False

os.environ["CUDA_VISIBLE_DEVICES"] = gpu_number

experiment_dict_filename = log_folder + f'/stamp_06_21_cam_20_runs_round2.json'
...
experiment_log_folder = log_folder + f'/stamp_06_21_results'
