...
cam_number = 3 
experiment_log_folder = log_folder + f'/stamp_perspective_comp_06_21'
if not os.path.exists(experiment_log_folder):
    os.mkdir(experiment_log_folder)
gpu_number = "0"
use_neptune = False
log_locs = [20, 60, 100, 150] #, 200]
iterations = 200

os.environ["CUDA_VISIBLE_DEVICES"] = gpu_number

for cam_number in range(25): #range(20, 21):
    ...
    # config_dict["sample_info"]["depth_range"] = (-1.7, -0.4)
